...
from newsreclib.data.components.npr_dataframe import NPRDataFrame
from newsreclib.data.components.news_dataset import DatasetCollate, NewsDataset


class NPRNewsDataModule(LightningDataModule):
    ...
    def prepare_data(self):
        ...
        NPRDataFrame(
            ...
            frame_annotator= self.hparams.frame_annotator,
